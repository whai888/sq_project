...
<div class="right">
        ...
        <table border="0" style="margin-top: 60px;margin-left: 25px;display: inline-table;">
        	<tr><td rowspan="2" width="40px;"><img alt="交易失败" src="<%=basePath%>images/error.gif" width="48" height="48" /></td>
        	<td height="90px;" style="padding-left: 20px;"><s:property value="#request.errorForm.message"/></td></tr>
        	<tr>
        	<td style="text-align: right;width: 330px;">
        		<div style="width: 100px;float: right;">
        		<a class="btn" onClick="javascript:window.history.go(-1)">
					<cite>返&nbsp;&nbsp;&nbsp;回</cite></a>
					</div>
			</td></tr>
        </table>
