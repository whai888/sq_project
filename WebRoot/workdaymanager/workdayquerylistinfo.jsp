...
%>
	...
	<div class="right">
     ...
     <tr>
      ...
      <tr>
        <td height="32" style="font-weight: bold; text-align: right" width="150px;">任务时长：</td>
        <td height="32" width="200px;">
        	<s:property value="sqWorkdayManager.taskTime"/>小时
        </td>
        <td height="32" style="font-weight: bold; text-align: right" width="150px;">工作成果：</td>
        <td height="32" width="200px;" colspan="3">
        	<s:property value="sqWorkdayManager.workLoad"/><s:property value="#request.sq_project_stepwork_units[sqWorkdayManager.workUnits]"/>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="32" width="150px;"  colspan="6">
     ...
     <s:iterator value="#request.projectDocList">
      <tr>
        <td height="32" width="150px;" colspan="6"><a href="<s:property value="filePath"/>/<s:property value="fileName"/>"><s:property value="backfileName"/></a></td>
      </tr>
      </s:iterator>
    </table>
				</div>
