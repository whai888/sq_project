...
<div class="right">
			...
			<form action="systemnotify.shtml" method="post" name="jform" id="jform">
      ...
      <tr>
        ...
        <td height="32" class="bgcolor1 fontleft fontbold" align="center" colspan="3">
        	<select name="FLAG">
      ...
      <tr>
        ...
        <td height="22" style="text-align: left">
        	<a href="findartidforcontent.shtml?sqArticleManager.artId=<s:property value="artId"/>&returnPage=findartidforcontent" class="form_font" >
