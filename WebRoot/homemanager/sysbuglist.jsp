...
<script type="text/javascript" src="js/sysbuglist.js"></script>
</head>
<%
...
<div class="right">
			...
			<form action="sysbugquery.shtml" method="post" name="jform" id="jform">
      ...
      <tr>
        <td height="22" style="font-weight:bold" width="15%">提交日期</td>
        <td height="22" style="font-weight:bold" width="70%">标题</td>
        <td height="22" style="font-weight:bold" width="15%">发布人</td>
      </tr>
      ...
      <tr>
        ...
        <td height="22" style="text-align: left">
        	<a href="findartidforcontent.shtml?sqArticleManager.artId=<s:property value="artId"/>&returnPage=sysbuginfo" class="form_font">
