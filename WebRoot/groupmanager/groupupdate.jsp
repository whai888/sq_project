...
<html>
	<head>
		...
		<script type="text/javascript" src="js/groupupdate.js"></script>
	</head>
	<%
	ApplicationDate.getRequestData("SYS_PARA_DATA" , Arrays.asList("sq_group_tabstatus") , request , "sq_group_tabstatus" );
	...
	<body>
		<div class="right">
			...
			<div class="right_centerwk">
				<form action="updategroup.shtml" method="post" name="jform"
					id="jform">
					<table border="0" width="100%" class="form_table_l">
						...
						<tr>
							...
							<td height="32" class="bgcolor1 fontleft fontbold">
								<input type="text"
									value="<s:property value="sqGroupTab.sqUserTab.userName"/>"
									name="groupUser" id="openpopup" readonly="readonly"
									onclick="openPopup()">
								<input type="hidden"
									value="<s:property value="sqGroupTab.sqUserTab.userId"/>"
						...
						<tr>
							...
							<td height="32" class="bgcolor1 fontleft fontbold">
								<input type="text" id="datepick1" maxlength="10" onfocus="$(this).calendar()"
					...
					<input type="hidden"
						value="<s:property value="sqGroupTab.groupNo"/>"
						name="sqGroupTab.groupNo">
					<!-- 部门编号 -->
				</form>
			</div>
		</div>
