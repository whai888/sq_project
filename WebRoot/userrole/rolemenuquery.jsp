...
<html>
	<head>
		...
		<script type="text/javascript" src="js/rolemenuquery.js"></script>
	...
	<body>
		<div class="right">
			...
			<div class="right_centerwk">
				<form action="rolemenuquery.shtml" method="post" name="jfrom"
					id="jfrom">
						...
						<tr>
							...
							<td height="32" class="bgcolor1 fontleft fontbold">
								<s:select name="sqRole.roleId" theme="simple"
									list="#request.roleList" listKey="roleId" listValue="roleName"
									onchange="onChangeRoleQuery()"></s:select>
							</td>
						</tr>
					</table>
				</form>
			...
			<br />
			<br />
			<form action="rolemenuconfirm.shtml" method="post" name="assignForm"
				id="assignForm">
