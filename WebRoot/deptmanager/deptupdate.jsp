...
<html>
	<head>
		...
		<script type="text/javascript" src="js/deptupdate.js"></script>
	</head>
	<%
	...
	for (SqDeptUsermanager deptUserSet : deptSet) {
		if(!deptUserSet.getId().getUserTab().getUserId().equals(sqDeptTab.getDeptUser())){
			userName += deptUserSet.getId().getUserTab().getUserName() + "  ";
			userId += deptUserSet.getId().getUserTab().getUserId() + "|" ;
		}
	}
%>
	<body>
		<div class="right">
			...
			<div class="right_centerwk">
				<form action="updatedept.shtml" method="post" name="jform"
					id="jform">
					<table border="0" width="100%" class="form_table_l">
						...
						<tr>
							...
							<td height="32" class="bgcolor1 fontleft fontbold">
								<input type="text"
									value="<s:property value="sqDeptTab.sqUserTab.userName"/>"
									name="deptUser" id="openpopup" readonly="readonly"
									onclick="openPopup()">
								<input type="hidden"
							...
							<td height="32" class="bgcolor1 fontleft fontbold">
								<input type="text" value="<%=userName %>" name="zhuliuserName" id="openzhuli" size="40" readonly="readonly">
								<input type="hidden" name="zhuliuserId" value="<%=userId %>" readonly="readonly">
							</td>
						</tr>
						<tr>
							<td height="32" style="font-weight: bold; text-align: right">
					...
					<input type="hidden" value="<s:property value="sqDeptTab.deptNo"/>"
						name="sqDeptTab.deptNo">
					<!-- 部门编号 -->
				</form>
			</div>
		</div>
